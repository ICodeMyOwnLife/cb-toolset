export declare type CreateRecordOf<TValue> = <TKey extends keyof any>(record: Record<TKey, TValue>) => Record<TKey, TValue>;
/**
...
export declare type OmitFrom<TObject, TKey extends keyof TObject> = Omit<TObject, TKey>;
export declare type PickFrom<TObject, TKey extends keyof TObject> = Pick<TObject, TKey>;
