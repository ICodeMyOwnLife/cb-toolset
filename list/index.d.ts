 ...
 */
export declare const difference: <TItem>(...lists: List<TItem>[]) => List<TItem>;
export declare const filter: <TItem, TSpecific extends TItem>(list: List<TItem>, filterFunction: (item: TItem, index: number, list: List<TItem>) => item is TSpecific) => List<TSpecific>;
/**
 ...
 */
export declare const intersection: <TItem>(...lists: List<TItem>[]) => List<TItem>;
...
export declare const last: <TList extends List<any>>(list: TList) => TList[import("./types").Remaining<TList>["length"]];
